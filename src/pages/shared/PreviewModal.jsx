    ...
    return (
        ...
        >
            <div className="bg-card border border-border rounded-2xl shadow-2xl p-6 w-[95vw] md:w-[85vw] lg:w-[1000px] max-w-[100vw] max-h-[95vh] overflow-y-auto flex flex-col items-center gap-4 relative">
                ...
                <div className="relative overflow-auto border border-border rounded-xl shadow-inner bg-slate-100 min-h-[400px] max-h-[65vh] w-full flex justify-center items-start p-4">
                    <Document
                        file={fileUrl}
