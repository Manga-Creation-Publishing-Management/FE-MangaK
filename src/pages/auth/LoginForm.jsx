        ...
        <div className="w-full bg-card rounded-2xl p-8 transition-colors duration-300 relative">
            ...
            <form onSubmit={handleSignIn} className="space-y-5">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full py-3.5 bg-primary text-primary-foreground font-semibold rounded-xl hover:opacity-95 transition-opacity shadow-sm text-sm mt-6 cursor-pointer disabled:opacity-50"
                >
