      ...
      <div className="bg-card border border-border rounded-2xl p-8 w-full max-w-md shadow-xl text-center">
        ...
        <div className="mt-6 p-4 bg-muted rounded-lg text-left">
          ...
          <div className="space-y-2 text-sm">
            <button onClick={() => navigate('/mangaka')} className="block text-primary hover:underline">
              → Mangaka Dashboard
            </button>
            <button onClick={() => navigate('/assistant')} className="block text-primary hover:underline">
              → Assistant Dashboard
            </button>
            <button onClick={() => navigate('/tantou')} className="block text-primary hover:underline">
              → Tantou Editor Dashboard
            </button>
            <button onClick={() => navigate('/editorial')} className="block text-primary hover:underline">
