...
export function TaskManagement() {
  ...
  return (
    <>
            ...
            <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-card-foreground truncate">task title</h3>
                  <p className="text-sm text-muted-foreground mt-1">Chapter 2 • pagerange</p>
                </div>
              ...
              <div className="flex items-center justify-between gap-4 mt-4 pt-3 border-t border-border/50">
                <span className="text-sm text-muted-foreground">
                  Assigned to: <span className="font-medium text-foreground">Name</span>
                </span>
      ...
      {
        showCreateTaskModal &&
        <CreateTaskModal onClose={handleShowCreateTaskModal} showSeriesApproval={showSeriesApproval} showAssistantList={showAssistantList} />
      }
