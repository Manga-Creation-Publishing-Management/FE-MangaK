...
export function Breadcrumb({ items, className = "" }) {
  ...
  return (
    <nav 
      ...
      className={`sticky top-0 z-30 flex items-center flex-wrap gap-2 text-sm text-muted-foreground bg-card/90 backdrop-blur-md border border-border px-4 py-2.5 rounded-xl shadow-xs mb-6 ${className}`}
    >
      <Link 
